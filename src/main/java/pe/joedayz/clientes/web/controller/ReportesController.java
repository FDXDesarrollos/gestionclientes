...
public class ReportesController {
	...
	public void export(@RequestParam(value = "id", required = false) Integer id, ModelAndView model, HttpServletResponse response) throws IOException, JRException, SQLException {
